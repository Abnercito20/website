...
GamePlayManager = {
    ...
    preload: function() {
		var me=this;
        me.load.image('background',"assets/images/bosque.png");
		me.load.spritesheet("crow","assets/images/crow.png",97,120);
		me.load.spritesheet("man","assets/images/personaje1.png",112,156);
	...
	create: function() {
		...
		me.crow.animations.add("right",[0,1,2,3],6,true);
